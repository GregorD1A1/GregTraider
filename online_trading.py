...
if __name__ == '__main__':
    instruments = {'UK100': {'period': 5, 'volume': 0.03, 'decimal_places': 1, 'min_height': 15},
                   'US500': {'period': 5, 'volume': 0.01, 'decimal_places': 1, 'min_height': 9},
                   'DE30':  {'period': 5, 'volume': 0.01, 'decimal_places': 1, 'min_height': 30},
                   'FRA40': {'period': 30, 'volume': 0.01, 'decimal_places': 1, 'min_height': 40},
                   'SPA35': {'period': 15, 'volume': 0.01, 'decimal_places': 0, 'min_height': 40},
                   ...
                   'GOLD':  {'period': 5, 'volume': 0.02, 'decimal_places': 2, 'min_height': 2.5},
    ...
    strategy_list = create_strategy_list(instruments)
